...
import proColegio.beans.BNCurso;
 ...
 * @author Ghaos
 */
@WebServlet(name = "SvlCurso", urlPatterns = {"/SvlCurso"})
public class SvlCurso extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        BNCurso BNC = new BNCurso();
        JSONObject json = new JSONObject();
        Usuario user = BNU.getUsuarioSession();
        switch (accion) {
            case "getTipoCurso":
                
                ArrayList<TipoCurso> resp = BNC.getTiposCursos();
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(SvlCurso.class.getName()).log(Level.SEVERE, null, ex);
